...
public class ObtenerBotellasDeMezclaServerCall {
    private SeparacionSueroActivity activity;
    private Context context;

    public ObtenerBotellasDeMezclaServerCall(final SeparacionSueroActivity activity) {
        this.activity = activity;
        this.context = activity.getApplicationContext();
        String url = Constants.DOMAIN + "/api/botellademezcla/disponibles/" + Config.getNumeroOperario(activity);
