...
public class SeleccionarBotellaDeMezclaServerCall {
    private SeparacionSueroActivity activity;
    private Context context;

    public SeleccionarBotellaDeMezclaServerCall(final SeparacionSueroActivity activity, final Item botella) {
        this.activity = activity;
        this.context = activity.getApplicationContext();
        String url = Constants.DOMAIN + "/api/botellademezcla/seleccionar";
